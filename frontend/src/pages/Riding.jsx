      ...
      <div className="h-1/2  p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <h2 className="text-lg font-medium capitalize">Aryan Rai</h2>
            <h4 className="text-xl font-semibold -mt-1 -mb-1">MP 28 BB 5032</h4>
            <p className="text-sm text-gray-600">Maruti Suzuki Alto</p>
            <h1 className="text-lg font-semibold"> 2223 </h1>
          </div>
        </div>
          ...
          <div className="w-full mt-5">
            <div className="flex items-center gap-5 p-3 border-b-2 border-gray-300">
              ...
              <div>
                ...
                <p className="text-sm -mt-1 text-gray-600">Railway Station</p>
              </div>
            </div>
